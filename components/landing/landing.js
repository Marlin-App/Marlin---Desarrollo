...
export function LandingPage () {
    return (
      <ScrollView contentContainerStyle={styles.container}>
        <Image
          source={{ uri: '../../assets/img/marlin.png' }}
          style={styles.image}
        />
        <Text style={styles.title}>¡Bienvenido a nuestra App!</Text>
        <Text style={styles.subtitle}>
        Conéctate con el puerto, compra local y 
        apoya a lo nuestro
        </Text>
        ...
        <Text style={styles.enlace}>
          Ya tienes una cuenta? <Link style={styles.link} to={{ screen: 'Login' }} onPress={() => alert('aun no sirve')}>Ingresa a ella</Link>
        </Text>
