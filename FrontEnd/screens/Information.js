    ...
    return (
        ...
        <ScrollView className="w-full ">
            ...
            <View className="mt-4 items-center p-4">
                ...
                <Text className="font-Erode_regular text-main-blue dark:text-white text-[15px] w-full  mt-3">Nombre de usuario</Text>
                <TextInput
                    className="w-full border-2 border-light-blue dark:text-white dark:border-main-blue mt-2 rounded-md px-2"
                ...
                <Text className="font-Erode_regular text-main-blue dark:text-white text-[15px] w-full  mt-3">Correo Electrónico</Text>
                <TextInput
                    className="w-full border-2 border-light-blue dark:text-white dark:border-main-blue mt-2 rounded-md px-2"
