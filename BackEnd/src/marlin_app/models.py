...
class Order(models.Model):
    ...
    delivery_distance = models.CharField(max_length=250)
    delivery_price = models.IntegerField(null=True, blank=True)
    delivery_id = models.ForeignKey(User, on_delete=models.CASCADE, related_name='deliveries', null=True, blank=True)
    user_coordinates = models.CharField(max_length=100)
