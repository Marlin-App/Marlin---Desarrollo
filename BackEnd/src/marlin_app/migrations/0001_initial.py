# Generated by Django 5.1 on 2024-10-19 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_variation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_variations', to='marlin_app.itemvariation')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pendiente', 'Pendiente'), ('En progreso', 'En progreso'), ('Enviada', 'Enviada'), ('Entregada', 'Entregada'), ('Cancelada', 'Cancelada')], default='Pendiente', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_price', models.IntegerField()),
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='marlin_app.order')),
        ...
        migrations.AddField(
            ...
            name='store_item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variations', to='marlin_app.storeitem'),
        ),
        migrations.CreateModel(
            name='ItemImage',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('picture', cloudinary.models.CloudinaryField(max_length=255, verbose_name='image')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_images', to='marlin_app.storeitem')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
